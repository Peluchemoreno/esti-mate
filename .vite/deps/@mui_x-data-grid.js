...
function getCheckboxPropsSelector(groupId, autoSelectParents) {
  return createSelector2(gridRowTreeSelector, gridSortedRowIdsSelector, gridFilteredRowsLookupSelector, selectedIdsLookupSelector, (rowTree, sortedRowIds, filteredRowsLookup, rowSelectionLookup) => {
    ...
    return {
      isIndeterminate: selectedDescendentsCount > 0 && selectedDescendentsCount < selectableDescendentsCount || selectedDescendentsCount === selectableDescendentsCount && rowSelectionLookup[groupId] === void 0,
...
var useGridRowSelection = (apiRef, props) => {
  ...
  const runIfRowSelectionIsEnabled = React155.useCallback((callback) => (...args) => {
  ...
  const removeOutdatedSelection = React155.useCallback((sortModelUpdated = false) => {
